...
\subsection{Process}
\subsubsection{WBS}
Vi har delat upp i väldigt breda kategorier eftersom vi har begränsat med information så här i början på projektet. De kategorier på nivå två är såna som vi vet att vi kommer behöva göra.
\begin{figure}[htp]
    \centering
