...
\subsection{Process}
\subsubsection{WBS}
Då vi fortfarande befinner oss i början av projektet har vi begränsad information. Därför har vi valt att dela arbetet i breda kategorier. De kategorier på nivå två är såna som vi vet att vi kommer behöva göra.
\begin{figure}[htp]
    \centering
