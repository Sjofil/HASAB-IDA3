...
\title{Övning-5-delgrupp-2}
\author{Pontus och Anna}
\date{September 2021}
...
Christin, Malin Hollgren, Malin Planander, utvecklarna.
\subsection*{Vilken kunskap har dessa om krav?}
Christin har mycket god kunskap. Vi kan anta att Malin Planander har rätt bra kunskap med tanke på de många studentprojekt hon varit med om. Malin Hollgrens kravkunskaper har vi inte så bra koll på. När det gäller oss, utvecklarna, så kommer våra kunskaper från denna kursen och PUSP-kursen.
\section*{Uppgift 2}
\subsection*{Hur ska kraven specificeras? Dvs hur ska kravspecifikationen byggas upp och se ut?}
Datakraven kommer förmodligen att specificeras med hjälp av E/R-diagram och Virtual Windows. De funktionella kraven kommer specificeras med hjälp av dels användningsfall och task descriptions, och dels skärmbilder och prototyper. Visa krav kommer bara specificeras med rena kravtexter, t ex "En sida ska laddas på x sek". \\
Kravspecifikationen kan byggas upp med datakrav, funktionella krav och kvalitetskrav i separata sektioner. 
\section*{Uppgift 3}
\subsection*{Vilka metoder ska användas för att validera kraven i projektet?}
Testfall kommer att användas. Eventuellt kan vi granska varandras krav. 
\section*{Uppgift 4}
\subsection*{1. Hur ska kraven prioriteras?}
Funktionella krav ska prioriteras, men även krav som har med användarvänlighet ska prioriteras då det är 
ett absolut måste att systemet är enkelt att förstå och lära sig. 
\subsection*{Vilka krav ska prioriteras?}
Krav som har med användarvänlighet och prestanda. Även säkerheten i hur data lagras är viktig!
\subsection*{Vilken skala ska ni prioritera efter?}
1-5?. Fattar inte frågan riktigt.
