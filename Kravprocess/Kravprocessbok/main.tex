...
\begin{itemize}
    ...
    \begin{itemize}
        \item Då data är insamlad statistikförs detta via programmering, vilket är en av produktens viktiaste funktioner.
    \end{itemize}
    \item Marknadsföring
    \begin{itemize}
...
I abonnemangskostnaden ingår serverunderhåll, support samt eventuella tillägg till systemet. Detta medför ett bra kassaflöde och ger oss de ekonomiska förutsättningarna som krävs för de servrar och och lokaler vi kommer att behöva.


\subsection{Kundrelationer}
Vi anser att relationen med våra kunder kommer att vara långvarig tack vare vår inkomststrategi som är beroende av abonnemangskonstnad. Vi anser däremot kontakt kommer ske vid behov eftersom vi strävar efter att produkten vi levererar kommer att vara väldigt enkel att underhålla.

\subsection{Kundsegment}
Våran produkt kommer att fokusera på målgrupper som är större företag och kommuner. Eftersom grunden av våran produkt är skapad för att samla in och sammanställa data på ett skräddarsytt sätt så kommer produkten vara användbar för större företag och kommuner som har ett större antal personer de vill samla in data från. Inom ett företag kan det vara de anställda man vill samla in informaiton från medan kommuner möjligtvis vill samla information från aktörer inom kommunens gränser. 

\subsection{Kanaler}
\begin{itemize}
    \item Hemsida ( information och möjlighet att kontakta oss vid intresse).
    \item Konferenser och events ( Visa upp produkten samt möjlighet till kontakt).
