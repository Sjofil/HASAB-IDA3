...
\subsection{Våran användare}

De användarna våran produkt har är personer som jobbar inom någon slags service branch, vi har antagit att alla som tänker använda produkten är stressade och vill inte behöva spendera mer tid en nödvändigt på vår produkt.
Vi har även antagit att dessa användarna är personer runt 30-50 år och är förmodligen inte så vana vid att arbeta med datorer. När vi senare under projekts gång fick lite mer insikt till vilka våran användare var så märkte vi att vi har haft en rätt så bra uppfattning om vilka våran användare var redan från början. Så vi har inte behövt tänka om vilka våran användare kommer att vara.
