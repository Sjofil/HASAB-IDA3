...
\section{Bakgrund och mål}
    ...
    \begin{enumerate}
        ...
        \item \textbf{Administratör:} Administratören har tillgång till systemets alla funktioner.
         \item \textbf{Slutanvändare:} De användare som ingår i supply chain och uppmuntras att fylla i formuläret. 
    \end{enumerate}
    ...
    \begin{enumerate}
        \item ** av ** genomsnittliga slutanvändare ska kunna slutföra formuläret under ** mintuter. 
    \end{enumerate}
