...
\begin{itemize}
    ...
    \item  Tillgänglighet : 
    \begin{itemize}
        \item [--]Verktyget ska vara tillgängligt 98 procent av ett år om man har en obesvarad länk.
        \item [--]Verktyget ska vara tillgängligt från iOS, macOS, windows och android. 
    \end{itemize}
...
\begin{itemize}
    ...
    \item Tillgänglighet : 
    \begin{itemize}
        \item [--]Oförutsägbara händelser så som strömavbrott och serverfel kan leda till att kravet ej alltid kan uppfyllas. 
        \item[--] Gammal mjukvara hos användare kan leda till att alla inte har tillgång till verktyget.
    \end{itemize}
