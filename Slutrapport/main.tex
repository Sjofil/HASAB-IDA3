...
\textbf{Filip}: Haft rollen som projektledare vilket har medfört arbete som att planerat sprintar, förvaltat scrumboarden och varit talesperson vid interna och externa möten. Utöver rollen som projektledare har Filip jobbat med allt inom hemsidan och dokument, från att skapa templets med html och css för frontend till att implementera funktioner på hemsidan med API och javascript och tillslut skriva i dokument som slutrapporten.\\\\
\textbf{Anna}: Varit projektledare tillsammans med Filip. Lett till en delad arbetsfördelning med att förvalta scrumboarden och planerat sprintar. Har också haft ansvar för mail med kunden. Vid möten har tagit rollen som sekreterare vid möten och generellt jobbat mycket med dokument som slutrapporten. Utöver detta har Anna fokuserat på arbete med databas och API för att implementera funktioner som inloggning för admin och till vara med och skriva databasen.\\\\
...
\textbf{Oscar}: Har genom hela projektet haft stort focus på arbete med databas och api. Att implementera allt från inlogging för admin och svarspersoner, sammaställa data för brancher samt att skriva stora delar av databasen. Oscar har även varit delaktigt i att skriva slutrapporten.\\\\
...
Användbarhetstesterna var grunden för att kunna ändra systemets innehåll i syfte att göra systemet mer uppenbart och intuitivt för användaren. Testerna resulterade i att de användbarhetskrav gruppen framställt uppfylldes och systemet kunde därmed bekräftas vara tillräckligt intuitivt och uppebart.
