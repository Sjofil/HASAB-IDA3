...
\noindent\textbf{Sprint sju, vecka 48} \\\
...
Under projektets gång stötte vi på problem som vi inte hade räknat med från början. Det främsta problemet inom programmeringen kom från ramverket Flask och programmeringsspråket Python som ingen i gruppen hade kunskaper eller erfarenhet om. Bland annat fastnade gruppen i processen då databasen skulle länkas samman med hemsidan och att synkronisera funktioner på hemsidan med Flask.\\\\
Vår tidsuppskattning som gjordes i början för utvecklingsarbetet för olika deluppgifter var inte noggrann planerad. Vi hade inte ett tydligt tidsmål för hur mycket tid en teammedlem skulle lägga per sprint och därför kunde ibland vissa uppgifter antingen bli klara mycket fortare än räknat med eller ta ännu längre tid. Genom att blicka tillbaka tänker vi oss att det har varit en lärande process som lärt oss vikten av noggrann planering och att försöka göra mer realistiska tidsuppskattningar. Vi hade inte heller räknat med att under nästan två veckors period uppstod en paus i projektarbetet på grund av att vi befann oss mitt i en tentaperiod där all tid upptogs av studerande till tentor. Pausen ledde till att vi hamnade efter i planeringen och fick därför lägga mer tid för att ligga i fas igen för att undvika förseningar.\\\\
Backloggen utnyttjades mestadels för tekniska utvecklingen och har främjat arbetsflödet. Det gav en överblick över utförda uppgifter och underlättade arbetet mot att hålla deadlines.\\\\
