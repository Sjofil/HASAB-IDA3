...
Beställaren hade krav på ett enkelt användargränssnitt eftersom svarspersonerna antogs ha varierande teknisk kunskap. REFERERA TILL DON'tMAKE ME THINK.
...
Samma html-sida användes för samtliga frågor, där själva frågeinnehållet uppdateras dynamiskt med hjälp av JavaScript när användaren klickar i ett svarsalternativ. Som ett steg i att skapa en mer flexibel och modulär applikation hämtas frågorna och svaren direkt från databasen.

Applikationen innehåller även en administrationssida. Det är inte nåbar via användargränssnittet 
 På admin sidan kan man sammanställa data och få en överblick av statistiken men även söka efter svar från en viss aktör.  Appendix XXX. 
...
Adminsidan kan endast nås via URL:en för att inte förvirra personerna som svarar på formuläret. 
