...
Arbetet under första sprinten kretsade kring dokumentation och det var bestämt att ER-digaram samt flödesdiagram skulle framställas. Tidigt under sprintsen togs ett besult om att slopa UML-diagram där insperation från Matz, K [2] där det läggs fram att det vid agil utveckling behövs mindre dokument. 
...
Vi beslutade också att användaren skulle endast ha möjlighet att välja bland flervalsfrågor för enklare sammanställning av data. Detta stödjas och av [2] som menar att man endast ska visa nödvändig information för användarna.  
